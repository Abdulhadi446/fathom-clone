...
export const metadata: Metadata = { title: "Create account — Fathom" };
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-lg border border-neutral-800 bg-neutral-950/60 p-6">
          ...
          <p className="mb-5 text-sm text-neutral-500">
            Free, self-hosted, no third-party identity provider — your password is hashed with
            scrypt and your sessions live in this database.
          </p>
